...
class _WebViewScreenState extends State<WebViewScreen>
  ...
  Future<void> _toggleOverlay() async {
    ...
    if (_isTrackingEnabled) {
      ...
      // Save preference
      await PrefsUtil.setOverlayEnabled(false);
      ...
      if (hasPermission) {
        ...
        // Save preference
        await PrefsUtil.setOverlayEnabled(true);
  ...
  Future<void> _requestPermissionsSequence() async {
    ...
    await _initializeOverlayPermission();
  ...
  /// Initialize overlay permission at startup
  Future<void> _initializeOverlayPermission() async {
    try {
      bool hasPermission = await FlutterOverlayWindow.isPermissionGranted();
      if (!hasPermission) {
        debugPrint('📱 Requesting overlay permission at startup...');
        await FlutterOverlayWindow.requestPermission();
      } else {
        debugPrint('✅ Overlay permission already granted');
      }
    } catch (e) {
      debugPrint('❌ Error initializing overlay permission: $e');
    }
  }
